...
public class Notes_2d_basics {
    ...
    public static void main(String[] args) {
        ...
        // im assuming that the number of coloums and rows are odd
        int rowNum = arr2D.length/2;
        int colNum = arr2D[0].length/2;
        System.out.println(arr2D[rowNum][colNum]);
